...
//The proxyGitHub function provides the route to the token to provide it for the API request. And it also keeps it withheld from the client.
...
//This route is making a request for the new article page from the new.html.
//sendFile is one of the methods that is part of the response object that you put a file into. Put in the file name you're looking for and where it will look for it.
...
//This route is updating the authors by assigning an ID to whichever author we're calling upon.
//It gets this information from our API request.
